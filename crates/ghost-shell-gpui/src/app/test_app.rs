...
use crate::{
    AnyWindowHandle, App, AppCell, AppContext, AsyncApp, BackgroundExecutor,
    BorrowAppContext, Bounds, ClipboardItem, Context, Entity, ForegroundExecutor, Global,
    InputEvent, Keystroke, MouseButton, MouseDownEvent, MouseMoveEvent, MouseUpEvent,
    Pixels, Platform, PlatformTextSystem, Point, Render, Size, Task, TestDispatcher,
...
impl TestApp {
    ...
    pub fn simulate_new_path_selection(
        ...
        self.platform
            .simulate_new_path_selection(select);
    }
