...
use ghost_shell_gpui::Refineable;
...
impl Styled for MenuItemElement {
    fn style(&mut self) -> &mut ghost_shell_gpui::StyleRefinement {
        &mut self.style
    }
}
...
impl ParentElement for MenuItemElement {
    fn extend(
        &mut self,
        elements: impl IntoIterator<Item = ghost_shell_gpui::AnyElement>,
    ) {
...
mod tests {
    ...
    fn aria_label_sets_accessible_name(_cx: &mut ghost_shell_gpui::TestAppContext) {
